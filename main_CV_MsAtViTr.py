...
# sampling_ratio = 8
# data = data[::sampling_ratio,::sampling_ratio,:]
# gt = gt[::sampling_ratio,::sampling_ratio]
...
for i in range(5):
    ...
    #model.save_weights('./Models_Weights/'+ dataset +'/MyModel)No_attebtion_iter_' + str(i)+'.h5')
    
    #model.load_weights('./Models_Weights/'+ dataset +'/MyModel_iter_' + str(i)+'.h5')
...
i = int(input("Eneter Iteration number: "))
model.load_weights('./Models_Weights/'+ dataset +'/MyModel_iter_' + str(i)+'.h5')
